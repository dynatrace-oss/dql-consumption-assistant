...
const useFetchNotebooksUsers = () => {
  ...
  const queryResult = useCustomDqlQuery({
    body: {
      query: notebooksUsers({ ...timeframe }),
    },
  ...
  const modifiedResult: NotebooksUsersQueryResultType[] =
...
export default useFetchNotebooksUsers;
